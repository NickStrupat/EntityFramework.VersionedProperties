...
namespace EntityFramework.VersionedProperties {
	...
	[ComplexType] public sealed class VersionedSingle                 : VersionedBase<VersionedSingle, Single, SingleVersion, ISingleVersions> {}
	[ComplexType] public sealed class VersionedGuid                   : VersionedBase<VersionedGuid, Guid, GuidVersion, IGuidVersions> {}
	[ComplexType] public sealed class VersionedInt16                  : VersionedBase<VersionedInt16, Int16, Int16Version, IInt16Versions> {}
	...
	[ComplexType] public sealed class VersionedNullableSingle         : VersionedBase<VersionedNullableSingle, Single?, NullableSingleVersion, INullableSingleVersions> {}
	...
	[ComplexType] public sealed class VersionedNullableInt16          : VersionedBase<VersionedNullableInt16, Int16?, NullableInt16Version, INullableInt16Versions> {}
	...
	[ComplexType] public sealed class VersionedByteArray              : VersionedBase<VersionedByteArray, Byte[], ByteArrayVersion, IByteArrayVersions> {}
	[ComplexType] public sealed class VersionedRequiredByteArray      : VersionedRequiredValueBase<VersionedRequiredByteArray, Byte[], RequiredByteArrayVersion, IRequiredByteArrayVersions> {
